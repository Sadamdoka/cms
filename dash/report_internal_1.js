                ...
                try {
                    ...
                    if (!isEmpty(data)) {
                        ...
                        if (!isJsonArray(jdata)) {
                            ...
                            document.getElementById('user_name').innerHTML = value.name;
                            document.getElementById('official_name').value = value.name;
                            document.getElementById('official_email').value = value.email;
                            document.getElementById('official_phone').value = value.phone;
            ...
            success: function (data) {
                ...
                try {
                    ...
                    if (!isEmpty(data)) {
                        ...
                        alert("Your/They Not Registered With US");
                        loadOrgan('1', 'mw_lco', "<option  disabled selected hidden >Choose Ugandan/Sending Recruitment Agency</option>");
                        loadOrgan('2', 'mw_fco', "<option  disabled selected hidden >Choose Saudi/Receiving Recruitment Agency</option>");
                    }
                    //appending data
                    //$("#logs").append(e_data);
                } catch (e) {
...
//Who Selecter
    ...
    let mw_lco_email = $("#mw_lco :selected").attr('value');
    ...
    /**let pass_status = $("#status_pass :selected").attr('id');
     switch (pass_status) {
     case'1':
     break;
     case '2':
     ...
     * */
    //if (who === "1") {
    //insertCase("0", "NA", "NA", "NA", "NA", "NA", "NA", mw_name, mw_phone, mw_email, mw_passport, mw_sys_id, mw_country, mw_city_residence, mw_passport_status, mw_emp_sector, mw_lco_id, mw_lco, mw_lco_tel, mw_lco_email, mw_fco_id, mw_fco, mw_fco_tel, mw_fco_email, mw_emp_name, mw_emp_number, location, mw_current_loca, comp_help, mw_comp_category);
    //} else if (who === "4") {
    ...
    //} else {
    //   insertCase("0", who, who_name, who_tel, who_email, who_city, source_info, mw_name, mw_phone, mw_email, mw_passport, mw_sys_id, mw_country, mw_city_residence, mw_passport_status, mw_emp_sector, mw_lco_id, mw_lco, mw_lco_tel, mw_lco_email, mw_fco_id, mw_fco, mw_fco_tel, mw_fco_email, mw_emp_name, mw_emp_number, location, mw_current_loca, comp_help, mw_comp_category);
    //}
}
